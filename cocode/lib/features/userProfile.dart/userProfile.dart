...
import 'package:cocode/MoreInfoPage.dart';
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                Text(
                                  'FnameLname' // must be from database
                                  ,
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 0.093 *
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Text(
                                "parameter from text filed from Edite profile",
                                style: TextStyle(
                                  fontSize: 16,
                                  color: Colors.black,
                                ),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: <Widget>[
                        Padding(
                          padding:
                              EdgeInsets.only(left: 30.0, top: 25, bottom: 20),
                          child: Text(
                            "My Projects",
                            style: TextStyle(
                                color: Color(0xff2A4793),
                        ...
                        Padding(
                          ...
                          padding: EdgeInsets.only(left: 27.0, right: 22.0),
